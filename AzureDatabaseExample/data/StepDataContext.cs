...
namespace AzureDatabaseExample.data;

public partial class StepDataContext : DbContext
{
    public StepDataContext()
    {
    }

    public StepDataContext(DbContextOptions<StepDataContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=stepserver.database.windows.net;Database=StepData;User Id=useradmin;Password=4012434HasanEv;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA7F18D679");
